          ...
          child: Container(
            ...
            child: ListView(
              children: [
                ...
                Center(
                  child: AnimatedTextKit(repeatForever: false, animatedTexts: [
                    ColorizeAnimatedText(' Galaxy',
                ...
                GestureDetector(
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          width: mediaQuerry.size.width * 0.07,
                        ),
                        FaIcon(
                ...
                SizedBox(
                  height: mediaQuerry.size.height * 0.16,
                ),
                Center(
                    child: Text(
                  'V.1.0.0',
