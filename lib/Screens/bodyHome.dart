                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                          ...
                                          child: QueryArtworkWidget(id: context.watch<SongModelProvider>().id, type: ArtworkType.AUDIO)),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(
                                              context.watch<SongModelProvider>().currentSong?.displayNameWOExt??'No Song',
                                              style: TextStyle(
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              ...
                                              context.watch<SongModelProvider>().currentSong?.artist ?? 'No Artist',
                                              style: TextStyle(
                                                  fontSize: 12,
                                                  color: const Color.fromARGB(
                                                      255, 255, 255, 255)),
